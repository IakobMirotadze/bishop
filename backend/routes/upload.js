        ...
        if (rolesControl["productimages/add"]) {
            if (req.file)
                ...
                return res.json({
                    ...
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\products\\", "images/uploads/products/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({
    ...
    (req, res) => {
        ...
        if (rolesControl["cargoes/add"]) {
            ...
            if (req.file)
                return res.json({
                    msg: "image successfully uploaded",
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\cargoes\\", "images/uploads/cargoes/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({
    ...
    (req, res) => {
        ...
        if (rolesControl["orderstatus/add"]) {
            if (req.file)
                return res.json({
                    msg: "image successfully uploaded",
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\orderstatus\\", "images/uploads/orderstatus/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({
    ...
    (req, res) => {
        ...
        if (rolesControl["paymentmethods/add"]) {
            if (req.file)
                return res.json({
                    msg: "image successfully uploaded",
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\paymentmethods\\", "images/uploads/paymentmethods/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({
    ...
    (req, res) => {
        ...
        if (rolesControl["brands/add"]) {
            if (req.file)
                return res.json({
                    msg: "image successfully uploaded",
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\brands\\", "images/uploads/brands/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({
    ...
    (req, res) => {
        ...
        if (rolesControl["homeslider/add"]) {
            if (req.file)
                return res.json({
                    msg: "image successfully uploaded",
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\homeslider\\", "images/uploads/homeslider/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({
    ...
    (req, res) => {
        ...
        if (rolesControl["superadmin"]) {
            if (req.file)
                return res.json({
                    msg: "image successfully uploaded",
                    path: req.file.path.replace("..\\admin\\public\\images\\uploads\\logo\\", "images/uploads/logo/"),
                });
            res.send("Image upload failed");
        } else {
            res.status(403).json({

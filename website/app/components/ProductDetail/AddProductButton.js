...
const Page = ({
   ...
   return (
      <div className=" gap-4 xl:flex lg:grid">
         ...
         <Button
            type="primary"
            className=" xl:w-7/12 w-full border-black bg-black text-xl h-auto hover:bg-white hover:border-black hover:text-black"
        ...
        Buy Now
         ...
         <Button
            type="primary"
            className="  xl:w-4/12 w-full border-brand-color bg-brand-color text-xl h-auto  hover:bg-white hover:border-brand-color hover:text-brand-color"
            disabled={!disabledVariant}
            onClick={() => {
               form
                  .validateFields()

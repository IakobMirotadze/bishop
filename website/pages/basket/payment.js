...
const Page = () => {
   ...
   return (
      <div className="container-custom h-full grid grid-cols-12 ">
         <Head title="Payments" />
         <div className="col-span-12 lg:col-span-8 shadow-lg m-4 grid-cols-2 my-8 gap-9 py-5 bg-white order-2 lg:order-1">
            <StripeComponent
               basket={basket}
         ...
         <div className=" col-span-12 lg:col-span-4 shadow-lg m-4 grid-cols-2 bg-white my-8 gap-9 order-1 lg:order-2">
            <DetailPricePay />
         </div>
      </div>
   );
